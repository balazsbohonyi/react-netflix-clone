  ...
  it('renders the sign up page with a form submission', async () => {
    ...
    await act(async () => {
      ...
      await fireEvent.change(getByPlaceholderText('Email address'), {
        target: { value: 'balazs.bohonyi@gmail.com' },
      });
      ...
      expect(getByPlaceholderText('First Name').value).toBe('Balazs');
      expect(getByPlaceholderText('Email address').value).toBe('balazs.bohonyi@gmail.com');
